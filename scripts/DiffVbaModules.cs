...
var options = WorkbookSyncHelpers.ParseDiffScriptOptions(args, config, Environment.CurrentDirectory);
if (options.ShowHelp)
{
    Console.WriteLine(WorkbookSyncHelpers.BuildDiffHelp(config, Environment.CurrentDirectory));
    return;
}
