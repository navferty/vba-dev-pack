...
if (options.ShowHelp)
{
    Console.WriteLine(WorkbookPackageHelpers.BuildExportHelp(config, Environment.CurrentDirectory));
    return;
}
    ...
    bool force)
{
    ...
    try
    {
        ...
        var html = VbaDiffEngine.BuildHtmlReport(compare, workbookPath, sourceDir, tempExportDir, DiffDirection.Export);
